...
public class GuiPickBlock extends InventoryEffectRenderer
{
    ...
    protected void handleMouseClick(@Nullable Slot slotIn, int slotId, int mouseButton, ClickType type)
    {
        ...
        {
            ItemStack itemStack3 = slotIn == null ? null : this.inventorySlots.getSlot(slotIn.slotNumber).getStack();
            ItemStack itemStack4;
            if(containterPickBlock.resultSlot.getStack()!=null) {
                itemStack4 = containterPickBlock.resultSlot.getStack().copy();
                if (itemStack3!=null && itemStack3.isItemEqual(itemStack4) && itemStack4.stackSize < itemStack4.getMaxStackSize())
                    itemStack4.stackSize = itemStack4.stackSize + 1;
                else
    ...
    public void handleMouseInput() throws IOException
    {
        ...
        if (i != 0 && this.needsScrollBars())
        {
            ...
            this.currentScroll = Math.min(Math.max(this.currentScroll, 0.0F), 1.0F);
